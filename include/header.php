                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-primary mr-1"></i>+977 9876543210</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-primary mr-1"></i>office@Estate.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="main-nav secondary-nav hover-primary-nav py-2">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> 
                                <a class="logo nav-item nav-link active" href="index.php">
                <h1>Norden<br>Real Estate</h1>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
									...
									<a class="btn btn-primary d-none d-xl-block" href="appointmentbook.php">Book Appointment</a> 
