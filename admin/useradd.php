...
if(isset($_POST['add'])) {
    ...
    $utmp_name = $_FILES['uimage']['tmp_name'];
    $ulocation = "user/".$uimage;

    move_uploaded_file($utmp_name, $ulocation);

    $sql = "INSERT INTO user (uname, uemail, upassword, uphone, uimage, utype) VALUES ('$uname', '$uemail', '$upassword', '$uphone', '$uimage', 'user')";
    $result = mysqli_query($con, $sql);

    if($result) {
        $msg = "<p class='alert alert-success'>User Added Successfully</p>";
    } else {
        $error = "<p class='alert alert-warning'>User Not Added. Some Error Occurred</p>";
    }
}
?>
<!DOCTYPE html>
