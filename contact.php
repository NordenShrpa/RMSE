...
<!--	Title
	=========================================================-->
<title>RealEstate - Contact</title>
</head>
<body>
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">Kathmandu, 03, Nepal</span> 
										<span class="text-secondary">Kathmandu, 03, Nepal</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-secondary">+977 9876543210</span>
										<span class="text-secondary">+977 1234567890</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-secondary">helpline@Estate.com</span>
										<span class="text-secondary">helpline@Estate.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
